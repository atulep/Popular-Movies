...
public class MoviesContract {
    ...
    public interface DetailsColumns {
        ...
        @DataType(DataType.Type.TEXT) @NotNull String POSTER_IMAGE = "poster_image";

        @DataType(DataType.Type.TEXT) @NotNull String PLOT = "plot";

        @DataType(DataType.Type.REAL) @NotNull String RATING = "rating";

        @DataType(DataType.Type.TEXT) @NotNull String RELEASE_DATE = "release_data";
    }
    ...
    public interface TrailerColumns {
        ...
        @DataType(DataType.Type.TEXT) String TRAILER_PATH = "trailer_path";
    }
    ...
    public interface ReviewColumns {
        ...
        @DataType(DataType.Type.TEXT) String REVIEW = "review";
    }
}
